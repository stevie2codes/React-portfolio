...
function Projects(props) {
  return (
    <div>
      ...
      <FadeIn transitionDuration={1200}></FadeIn>
      <div className="card-columns">
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              A Photographers portfolio built on React and deployed with AWS.
              Utilizing Cloudfront , S3 buckets and route53
            </p>
            <p className="card-text">
              <Tooltip
                placement="left"
          ...
          >
            <blockquote className="blockquote text-center text-dark">
              <p className="mb-0">
                ...
                design, in part because good designs fit our needs so well that
