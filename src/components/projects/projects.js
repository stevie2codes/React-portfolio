          ...
          <div className="card-columns">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  animations or use the internal IDE to create save and update
                  new animations.
                </p>
                <p className="card-text">
                  <Tooltip
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  A react application utilizing pagination, filtering and
                  sorting.
                </p>
                <p className="card-text">
                  <Tooltip
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  A recipe keeper saving recipes in a database and searching a
                  3rd party API to find new ones!
                </p>
                <p className="card-text">
                  <Tooltip
                    placement="left"
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  A timed health quiz utilizing jquery DOM manipulation and
                  local storage.
                </p>
                <p className="card-text">
                  <Tooltip
