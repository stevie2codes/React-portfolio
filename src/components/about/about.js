          ...
          <div className="aboutText row ">
            ...
            <div className="list col-md-6">
              <p className="skillList">
                ...
                MERN STACK- Mongo, Express,React,Node,React Native,Vue, CSS,
                SASS, bootstrap, JavaScript animaition libraries, JavaScript,
                jQuery, MySQL, Mongoose,AWS, git, github, MVC Agile,SCRUM and
                team projects. Figma Design Sytems . Ui/Ux Design principles.
              </p>
            </div>
          </div>
        </motion.div>
